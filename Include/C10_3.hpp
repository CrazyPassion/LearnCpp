//
// Created by vonking on 2017/7/10.
//
...
void biggies(std::vector<std::string> &vs, std::size_t sz)
{
    ...
    // if we not capture sz,the compile will throw error:
    // variable 'sz' cannot be implicitly captured in a lambda with no capture-default specified
